...
set MAIN_JAR=dcm4che-tool-syslogd-3.3.8-SNAPSHOT.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-audit-3.3.8-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-3.3.8-SNAPSHOT.jar
set CP=%CP%:%DCM4CHE_HOME%\lib\dcm4che-conf-core-api-3.3.8-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-audit-3.3.8-SNAPSHOT.jar
