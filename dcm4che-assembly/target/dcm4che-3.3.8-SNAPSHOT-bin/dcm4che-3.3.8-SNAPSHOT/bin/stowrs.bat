...
set MAIN_JAR=dcm4che-tool-stowrs-3.3.8-SNAPSHOT.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-json-3.3.8-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-ws-rs-3.3.8-SNAPSHOT.jar
